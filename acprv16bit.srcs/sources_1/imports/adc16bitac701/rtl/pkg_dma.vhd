...
-- Declare constants
  ...
  Constant  C_EMU_FIFO_DC_WIDTH   : integer      :=   13;
...
--------  SIMONE USER REGISTER 01 rx(R) + tx (W)
  ...
  Constant  CINT_ADDR_REG11       : integer  := 54;

  --------  Board2Host FIFO status (R) 
  Constant  CINT_ADDR_REG12       : integer  := 55;

  --------  SIMONE USER REGISTER 11 rx(R) + tx (W)
  Constant  CINT_ADDR_REG13              : integer  := 56;

  --------  SIMONE USER REGISTER 12 rx(R) + tx (W)
  Constant  CINT_ADDR_REG14              : integer  := 57;

  ------------------------------------------------------------------------
  --        Number of registers
  Constant  C_NUM_OF_ADDRESSES           : integer  := 58;
  -- 
  ------------------------------------------------------------------------
